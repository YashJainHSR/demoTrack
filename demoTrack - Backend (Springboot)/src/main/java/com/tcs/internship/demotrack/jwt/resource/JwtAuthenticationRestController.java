...
import com.tcs.internship.demotrack.jwt.JwtTokenUtil;
...
public class JwtAuthenticationRestController {
	...
	public static void setTokenHeader(String th) {
		tokenHeader = th;
	}
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtTokenRequest authenticationRequest)
		...
		UserCredentials user = userCredentialsRepository.findByUsername(authenticationRequest.getUsername());
